<template>
  <v-container class="pt-4 pb-16 mb-4" v-scroll="onScroll">
    ...
    <settings-edit v-bind:id="editId" v-bind:dialog="editDialog" v-on:close-edit="editDialog = false" v-on:edit-updated="editUpdated" />
  </v-container>
</template>
  ...
  export default {
    ...
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Wartość', align: 'start', sortable: true, value: 'content' },
